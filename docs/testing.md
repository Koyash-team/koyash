...
|---|---|---:|---:|---|
| `backend/app/api/recommend.py` | Owns the core product value: hard filtering (vegan/cruelty-free/allergens), segment fallback, skin-type preference, basket assembly, per-product justification, the special-condition safety filter (US-20), the deterministic irritant warning (US-11), and the optional LLM justification overlay (US-14) (US-04, US-05, US-08, US-09, US-11, US-14, US-20). | 30% | 100% | [Backend tests + QRTs + coverage run](https://github.com/Koyash-team/koyash/actions/runs/29075414127/job/86305816085) |
